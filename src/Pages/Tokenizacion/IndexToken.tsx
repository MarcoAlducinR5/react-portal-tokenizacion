...
import { useObtenerTarjetas } from "../../Hooks/ConsultarBilletera";
...
const Tokenizacion: FC = () => {
  ...
  const { dataResponse, loading, ObtenerTarjetas } =
    useObtenerTarjetas("501284984215");
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      <div
        className={`lg:border-[1px] border-sky-gray-500 rounded-[10px] mx-9 my-[125px] lg:mx-0 lg:my-[153px] w-[320px] h-[1900px] lg:w-[728px]  lg:px-[18px] lg:py-8 ${
          requerido ? "lg:h-[1435px]" : "lg:h-[1335px]"
        }`}
      >
        <div className="flex justify-between items-start flex-col lg:flex-row text-[#292929] border-b-[1px] border-sky-gray-500 pb-6">
          {loading ? "Consultando..." : dataResponse?.stateCode}
        </div>
        <div className="flex justify-between items-start flex-col lg:flex-row text-[#292929] border-b-[1px] border-sky-gray-500 pb-6">
          <div>
        ...
        <div className="radio-group flex justify-between items-center flex-row w-full lg:w-[692px] h-[100px] lg:h-[67px] px-2 lg:px-40 lg:my-5">
          ...
          <label
            htmlFor="option1"
            className="flex justify-center items-center rounded border-[1px] w-[69px] h-[46px] lg:w-[99px] lg:h-[67px] shadow-[0px 2px 8px 0px rgba(242, 242, 242, 1)]"
          >
            <div className="flex justify-center items-center rounded w-[67px] h-[45px] lg:w-[97px] lg:h-[66px] bg-white">
              <img
                src={visa}
                alt=""
                className="w-[54px] h-[54px] lg:w-[78px] lg:h-[79px]"
              />
            </div>
          </label>
          ...
          >
            <div className="flex justify-center items-center rounded w-[67px] h-[45px] lg:w-[96px] lg:h-[66px] bg-white">
              <img
                src={masterCard}
                alt=""
                className="w-[39px] h-[38px] lg:w-[66px] lg:h-[66px]"
              />
            </div>
          </label>
          ...
          >
            <div className="flex justify-center items-center rounded w-[67px] h-[45px] lg:w-[97px] lg:h-[66px] bg-white">
              <img
                src={aMex}
                alt=""
                className="w-[46px] h-[46px] lg:w-[80px] lg:h-[80px]"
              />
            </div>
          </label>
        </div>

        <span className="text-xl text-sky-black-100 text font-normal">
          ...
          <div className="flex flex-col h-[86px] lg:w-[205px] lg:h-[80px]">
            ...
            <div className="block my-1 lg:mb-0 lg:mt-1">
              <input
                ...
                name="nombre"
                placeholder="Nombre"
                className="w-full h-[40px] lg:h-[48px] rounded border-[1px] border-sky-gray-500 focus:outline-none focus:border-[#DA1E28] placeholder:text-base placeholder:text-sky-gray-120 placeholder:p-4"
              />
            </div>
          </div>
          <div className="flex flex-col h-[86px] lg:w-[205px] lg:h-[80px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between py-2 lg:py-4">
          ...
          <div className="flex flex-col h-[86px] lg:w-[326px] lg:h-[80px]">
            <div className="block my-1 lg:mt-0 lg:mb-1">
              <label className="text-sm text-[#292929]">
                Confirmar número de tarjeta
              </label>
            </div>
            <div className="block my-1 lg:mb-0 lg:mt-1">
              <input
                type="tel"
                name="confirmaTarjeta"
                placeholder="**** **** **** 0123"
                className="w-full h-[40px] lg:h-[48px] rounded border-[1px] border-sky-gray-500 focus:outline-none focus:border-[#DA1E28] placeholder:text-base placeholder:text-sky-gray-120 placeholder:p-4"
              />
            </div>
            ...
            <div className="flex flex-col w-[140px] lg:w-[205px] lg:h-[80px]">
              ...
              <div className="block my-1 lg:mb-0 lg:mt-1">
                <select
                  ...
                  className="w-full h-[40px] lg:h-[48px] rounded border-[1px] border-sky-gray-500 focus:outline-none focus:border-[#DA1E28] placeholder:text-base placeholder:text-sky-gray-120 placeholder:p-4"
                >
                  <option className="text-base text-sky-gray-120 p-4">
                    Mes
                  </option>
                  <option
                    className="text-base text-sky-gray-120 p-4"
                    value="01"
                  >
                    01
                  </option>
        ...
        <span className="text-xl text-sky-black-100 font-normal">
          Dirección
        </span>

        <div className="flex flex-col lg:flex-row justify-between pt-2 lg:pt-4">
          <div
            className={`flex flex-col lg:w-[446.5px] ${
              requerido ? "h-[104px]" : "h-[86px] lg:h-[80px]"
            }`}
          >
            <div className="block my-1 lg:mt-0 lg:mb-1">
            ...
            <div
              className={`h-[18px] text-xs text-[#DA1E28] ${
                requerido ? "block" : "hidden"
              }`}
            >
          ...
          <div
            className={`hidden lg:flex flex-col w-[205px] ${
              requerido ? "h-[104px]" : "h-[86px] lg:h-[80px]"
            }`}
          >
            <div className="block my-1 lg:mt-0 lg:mb-1">
            ...
            <div className="flex flex-col w-[140px]">
              ...
              <div className="block mt-1">
                <input
                  ...
                  name="exterior"
                  placeholder="No."
                  className="w-full h-[40px] rounded border-[1px] border-sky-gray-500 focus:outline-none focus:border-[#DA1E28] placeholder:text-base placeholder:text-sky-gray-120 placeholder:p-4"
                />
              </div>
              <div
                className={`h-[18px] text-xs text-[#DA1E28] ${
        ...
        <div className="flex flex-col lg:flex-row justify-between pt-2 lg:pt-4">
          <div
            className={`flex flex-col lg:w-[326px] ${
              requerido ? "h-[104px]" : "h-[86px] lg:h-[80px]"
            }`}
          >
            <div className="block my-1 lg:mt-0 lg:mb-1">
        ...
        <div className="flex flex-col lg:flex-row justify-between pt-2 lg:pt-4">
          ...
          <div
            className={`flex flex-col lg:w-[205px] ${
              requerido ? "h-[104px]" : "h-[86px] lg:h-[80px]"
            }`}
          >
            <div className="block my-1 lg:mt-0 lg:mb-1">
